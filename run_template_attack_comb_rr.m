function [results] = run_template_attack_comb_rr(...
    X_profile, V_profile, ...
...
%RUN_TEMPLATE_ATTACK_COMB_RR Runs a template attack against a crypto function
...
%   As a difference to RUN_TEMPLATE_ATTACK_COMB_R, during the attack this
%   method will use the same traces for n_attack < i for all attacks in the
%   same iteration, i.e. when using n_attack = 10 or n_attack = 20, the
%   traces from 1...9 will be the same.
%
...
[results.disc_info] = get_disc_info_comb_rr(...
